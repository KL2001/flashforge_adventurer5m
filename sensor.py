...
SENSOR_DEFINITIONS = {
    ...
    "chamberFanSpeed": ("Chamber Fan Speed", REVOLUTIONS_PER_MINUTE, SensorDeviceClass.FAN, SensorStateClass.MEASUREMENT, False, False),
    "coolingFanSpeed": ("Cooling Fan Speed", REVOLUTIONS_PER_MINUTE, SensorDeviceClass.FAN, SensorStateClass.MEASUREMENT, False, False),
